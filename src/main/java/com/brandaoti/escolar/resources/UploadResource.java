...
public class UploadResource {
	...
	public ResponseEntity<String> uploadAlunos(@ModelAttribute MultipartFile file) throws Exception {
	...
	@PreAuthorize("hasAnyRole('ADMINISTRADOR', 'PROFESSOR', 'ALUNO')")
	public ResponseEntity<String> uploadAulas(@ModelAttribute MultipartFile file) throws Exception {
		ProcessaExcel processaExcel = new ProcessaExcel();
		List<Tabela> tabelas = processaExcel.uploadAlunos(file);
